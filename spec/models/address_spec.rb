...
RSpec.describe Address, type: :model do
  ...
  it "is valid with valid attributes" do
    address = Address.new(user_id: 1, street_address: "1510 Blake Street",
      apt: "", city: "Denver", state: "CO", zip_code: 80010)
  ...
  it "is invalid without a state" do
    address = Address.new(user_id: 1, street_address: "1510 Blake Street",
      apt: "", city: "Denver", zip_code: 80010)
  ...
  it "only accepts a zip code 5 characters long" do
    address = Address.new(user_id: 1, street_address: "1510 Blake Street",
      apt: "", city: "Denver", state: "CO", zip_code: 8001)
  ...
  it "only accepts a zip code with integers" do
    address = Address.new(user_id: 1, street_address: "1510 Blake Street",
      apt: "", city: "Denver", state: "CO", zip_code: "ABCDE")
  ...
  it "only accepts a state 2 characters long" do
    address = Address.new(user_id: 1, street_address: "1510 Blake Street",
      apt: "", city: "Denver", state: "C", zip_code: 80010)
